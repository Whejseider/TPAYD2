...
import view.component.chart.*;
import view.component.chart.renderer.other.ChartCandlestickRenderer;
import view.component.chart.themes.ColorThemes;
import view.component.chart.themes.DefaultChartTheme;
import view.component.chart.utils.ToolBarCategoryOrientation;
import view.component.chart.utils.ToolBarTimeSeriesChartRenderer;
import view.component.dashboard.CardBox;
...
public class FormDashboard extends Form {
    ...
    private void createCard() {
        ...
        cardBox = new CardBox();
        cardBox.addCardItem(createIcon("demo/icons/dashboard/customer.svg", DefaultChartTheme.getColor(0)), "Total Customer");
        cardBox.addCardItem(createIcon("demo/icons/dashboard/income.svg", DefaultChartTheme.getColor(1)), "Total Income");
        cardBox.addCardItem(createIcon("demo/icons/dashboard/expense.svg", DefaultChartTheme.getColor(2)), "Total Expense");
        cardBox.addCardItem(createIcon("demo/icons/dashboard/profit.svg", DefaultChartTheme.getColor(3)), "Last Profit");
        panel.add(cardBox);
